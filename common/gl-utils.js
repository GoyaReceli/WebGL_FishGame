...
class GLUtils{
    ...
    */
    static createWebGLInstance(canvas, fitScreen = false, debug = false){
...
File:// was protocol used to load WebGL engine. Resources and Files can not be loaded with this protocol
